...
/*
    1) create variables for index, count
    2) loop through nums
        2.1) if the number at current index matches current number, continue
        2.2) else move the current item to number past index
        2.3) increment index and count
    3) return count
*/
